...
// Conversions between SL_Bus_DestinationControl_geometry_msgs_Point and geometry_msgs::Point

void convertFromBus(geometry_msgs::Point* msgPtr, SL_Bus_DestinationControl_geometry_msgs_Point const* busPtr)
{
...
void convertToBus(SL_Bus_DestinationControl_geometry_msgs_Point* busPtr, geometry_msgs::Point const* msgPtr)
{
  const std::string rosMessageType("geometry_msgs/Point");
...
// Conversions between SL_Bus_DestinationControl_geometry_msgs_Pose and geometry_msgs::Pose
...
// Conversions between SL_Bus_DestinationControl_geometry_msgs_Quaternion and geometry_msgs::Quaternion

void convertFromBus(geometry_msgs::Quaternion* msgPtr, SL_Bus_DestinationControl_geometry_msgs_Quaternion const* busPtr)
{
...
void convertToBus(SL_Bus_DestinationControl_geometry_msgs_Quaternion* busPtr, geometry_msgs::Quaternion const* msgPtr)
{
  const std::string rosMessageType("geometry_msgs/Quaternion");
...
// Conversions between SL_Bus_DestinationControl_geometry_msgs_Twist and geometry_msgs::Twist

void convertFromBus(geometry_msgs::Twist* msgPtr, SL_Bus_DestinationControl_geometry_msgs_Twist const* busPtr)
{
...
void convertToBus(SL_Bus_DestinationControl_geometry_msgs_Twist* busPtr, geometry_msgs::Twist const* msgPtr)
{
  const std::string rosMessageType("geometry_msgs/Twist");
...
// Conversions between SL_Bus_DestinationControl_geometry_msgs_TwistWithCovariance and geometry_msgs::TwistWithCovariance

void convertFromBus(geometry_msgs::TwistWithCovariance* msgPtr, SL_Bus_DestinationControl_geometry_msgs_TwistWithCovariance const* busPtr)
{
...
void convertToBus(SL_Bus_DestinationControl_geometry_msgs_TwistWithCovariance* busPtr, geometry_msgs::TwistWithCovariance const* msgPtr)
{
  const std::string rosMessageType("geometry_msgs/TwistWithCovariance");
...
// Conversions between SL_Bus_DestinationControl_geometry_msgs_Vector3 and geometry_msgs::Vector3

void convertFromBus(geometry_msgs::Vector3* msgPtr, SL_Bus_DestinationControl_geometry_msgs_Vector3 const* busPtr)
{
...
void convertToBus(SL_Bus_DestinationControl_geometry_msgs_Vector3* busPtr, geometry_msgs::Vector3 const* msgPtr)
{
  const std::string rosMessageType("geometry_msgs/Vector3");
...
// Conversions between SL_Bus_DestinationControl_nav_msgs_Odometry and nav_msgs::Odometry

void convertFromBus(nav_msgs::Odometry* msgPtr, SL_Bus_DestinationControl_nav_msgs_Odometry const* busPtr)
{
...
void convertToBus(SL_Bus_DestinationControl_nav_msgs_Odometry* busPtr, nav_msgs::Odometry const* msgPtr)
{
  const std::string rosMessageType("nav_msgs/Odometry");
...
// Conversions between SL_Bus_DestinationControl_ros_time_Time and ros::Time
...
// Conversions between SL_Bus_DestinationControl_std_msgs_Header and std_msgs::Header
