...
#define MW_PACKAGING_MAINTAINERNAME pierre
#define MW_PACKAGING_MAINTAINEREMAIL pierre.mollard@edu.Esiee.fr
#define MW_PACKAGING_LICENSE BSD
#define MW_PACKAGING_VERSION 1.0.0
#define MW_BOARDPARAMETERS_DEVICEADDRESS 192.168.1.88
#define MW_BOARDPARAMETERS_USERNAME pierre
