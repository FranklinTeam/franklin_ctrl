###########################################################################
## Makefile generated for Simulink model 'testConnexion'. 
## 
## Makefile     : testConnexion.mk
## Generated on : Thu May 07 16:24:57 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/testConnexion.elf
...
PRODUCT_NAME              = testConnexion
MAKEFILE                  = testConnexion.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2020a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2020a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/Pierre/Desktop/mathworks-robotics-mobile-robotics-simulation-toolbox-7066fa0/TestConnexion
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/testConnexion.elf
...
DEFINES_STANDARD = -DMODEL=testConnexion -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = testConnexion.cpp.o testConnexion_data.cpp.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o linuxinitialize.cpp.o slros_busmsg_conversion.cpp.o slros_initialize.cpp.o slros_generic_param.cpp.o
...
%.c.o : $(START_DIR)/testConnexion_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/testConnexion_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : $(START_DIR)/testConnexion_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
ert_main.cpp.o : $(START_DIR)/testConnexion_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


testConnexion.cpp.o : $(START_DIR)/testConnexion_ert_rtw/testConnexion.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


testConnexion_data.cpp.o : $(START_DIR)/testConnexion_ert_rtw/testConnexion_data.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slros_busmsg_conversion.cpp.o : $(START_DIR)/testConnexion_ert_rtw/slros_busmsg_conversion.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


slros_initialize.cpp.o : $(START_DIR)/testConnexion_ert_rtw/slros_initialize.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
